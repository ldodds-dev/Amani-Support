...
AMANI website: amani-browser.com

View support requests: Amani-Support Issues

Report a problem: Open a new issue
...
Confirm that you are using the most recent AMANI Beta available from amani-browser.com.

Restart AMANI and, when appropriate, restart your device.

Search the existing issues to see whether the problem has already been reported.

Test whether the problem occurs consistently or only under a particular network, device, location, or account condition.

Remove personal or sensitive information from screenshots, logs, addresses, searches, and filenames.

If an existing issue describes the same problem, add any new reproduction details there instead of opening a duplicate.

How to report a bug

Open a new issue and include as much of the following information as possible.
...
Download AMANI only through amani-browser.com or another location explicitly identified there as official.
...
Triage — Confirm the report contains enough information.

Reproduction — Attempt to reproduce the behavior in a supported environment.

Classification — Identify whether it is a bug, compatibility issue, feature request, documentation issue, or external-service problem.

Prioritization — Consider severity, user impact, privacy, security, and reproducibility.

Resolution — Implement a fix, document a workaround, request more information, or close the report with an explanation.
...
Use amani-browser.com. Avoid installers shared through unofficial mirrors, messages, or third-party download sites.
...
AMANI — Private by Default. Intelligent by Choice.
